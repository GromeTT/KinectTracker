...
#include "../../KinectTracker/inc/ProcessingPipelines/inc/Histogram.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Histogram_t, stringdata) + ofs \
...
const QMetaObject Histogram::staticMetaObject = {
    { &ProcessingComponent::staticMetaObject, qt_meta_stringdata_Histogram.data,
      qt_meta_data_Histogram,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Histogram.stringdata))
