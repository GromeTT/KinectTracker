...
#include "../../KinectTracker/inc/ImageWidget/inc/ImageWidget.h"
...
QT_MOC_LITERAL(5, 54, 10)
    ...
    "ImageWidget\0leftMousePressed\0\0point\0"
    "leftMouseReleased\0mouseMoved\0"
};
...
void ImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->leftMousePressed((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: _t->leftMouseReleased((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        ...
        {
            typedef void (ImageWidget::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageWidget::leftMousePressed)) {
                *result = 0;
            }
        }
        {
            typedef void (ImageWidget::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageWidget::leftMouseReleased)) {
                *result = 1;
            }
        }
        {
            typedef void (ImageWidget::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageWidget::mouseMoved)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void ImageWidget::leftMousePressed(QPoint _t1)
{
...
// SIGNAL 1
void ImageWidget::leftMouseReleased(QPoint _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ImageWidget::mouseMoved(QPoint _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
