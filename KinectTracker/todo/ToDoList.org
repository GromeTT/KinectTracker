...
* Ziele für heute
  ...
  + [ ] PCL einbinden
    ...
    + [ ] Extra Programm schreiben, dass die Schätzung des Bodens übernimmt.
...
* Neues Feature Histogram-Analyse
  + Funktionen:
    ...
    - [ ] Histogram vergleichen und Regionen einzeichnen
  + Probleme:
...
* TODO [7/26][26%]
  + [ ] Trackingstatus der einzelnen Joints anzeigen.
  + [ ] Kinect connect/disconnect Signal.
  + [ ] Rechtecke, die in cv::Mat gezeichnet werden sollen, müssen abgeschnitten werden,
    falls sie die Größe überschreiten.
    [[http://msdn.microsoft.com/en-us/library/nuiapi.nuisetdevicestatuscallback.aspx]]
  + [ ] Ebene für den Boden schätzen mittels PCL Lib.
    Brauch nicht über die PCL Lib gemacht werden, da die Kinect selber eine 
    Funktion dafür bereitstellt.
