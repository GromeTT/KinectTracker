...
* TODO [16/27][59%] Tasks
  + [ ] Kopfhistogram-Backprojection über alle Gelenke ausführen, wenn die Person liegt, um das
    Gesicht zu finden. 
  + [ ] Backprojection für alle Gelenke, wenn die Person liegt (evtl. hat die Person markante 
    Kleidung an, was die ermöglicht).
  + [ ] Bugfix für fixed skin region detection. Einschränkung auf den Bildbereich und nicht 
  ...
  + [X] Ebene für den Boden schätzen mittels PCL Lib.
